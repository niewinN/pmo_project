...
W folderze `notebooks/analysis.ipynb` możesz uruchomić eksplorację danych, wizualizacje itp. w VS Code lub Jupyter.

## Wykorzystanie SpeechBrain

W projekcie SpeechBrain jest wykorzystywany w dwóch aspektach:
- jako źródło metryki **SI-SNR** (`speechbrain.nnet.losses.si_snr_loss`),
- (opcjonalnie) jako baseline poprzez model `speechbrain/metricgan-plus-voicebank` w notatniku `analysis.ipynb`.

Główny model poprawy jakości mowy jest autorskim U-Netem 1D trenowanym na polskich danych Common Voice.
